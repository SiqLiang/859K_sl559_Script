...
#produce DEMFC30_DJDF1000m_+scientific_name+".tif"
...
DJDF1000m_roi= "C:\\859K_sl559\\Data\\SumUp_Dejure_Defacto\\DeJure_DeFacto1000m.tif"
...
for fileName in fileList:
    ...
    outRas = Raster(fileName)*Raster(DJDF1000m_roi)
    outRas.save("DEMFC30_DJDF1000m_"+scientific_name+".tif")
    print(outRas)
