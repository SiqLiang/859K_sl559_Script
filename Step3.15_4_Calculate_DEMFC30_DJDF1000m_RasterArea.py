...
print (os.path.exists("C:\\859K_sl559\\Doc\\DEMFC30_DJDF1000m_RasterArea.txt"))
# Create a new file in the current working directory, write some text, and remember to close it
Map_fileObj = open("DEMFC30_DJDF1000m_RasterArea.txt",'w')
Map_fileObj.truncate(0) # clear eveything already in the txt file
Map_fileObj.write('DEMFC30_DJDF1000m_Species, '+'Area_sqkm2'+"\n")
#Map_fileObj.close()
...
fileList = arcpy.ListRasters('DEMFC30_DJDF1000m_*', 'All')
print(len(fileList))
