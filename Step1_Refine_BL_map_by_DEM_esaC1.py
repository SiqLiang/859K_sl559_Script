...
arcpy.env.workspace = "C:\\859K_sl559\\Scratch_ESA"
arcpy.env.extent = "C:\\859K_sl559\\Data\\RegionOfInterest.shp"

#input datasets
inputShapefile = "C:\\859K_sl559\\Data\\ESA\\EndemicBirdSpecies_inROI_esaC1_Test2spp.shp"
DEM_roi = "C:\\859K_sl559\\Data\\Area_mask_DEM90m_final.tif"
ESA_Category1= "C:\\859K_sl559\\Scratch_ESA\\‪LC2018_ROI_Category1.tif"
...
for i in range (0,3,1):
    ...
    #BL_Map Refined by ESA_Category1
    ReBy_ESA_Category1 = Raster(BL_Map)*Raster(ESA_Category1)
    ReBy_ESA_Category1.save("ReBy_esaC1_"+scientific_name+".tif")
    
    #BL_Map Refined by both species elevation range and Forest Cover>30 (Double Refined)
    ReBy_DEMFC30 = Raster(BL_Map)*Raster(ConDEM)*Raster(ESA_Category1)
    ReBy_DEMFC30.save("ReBy_DEM_esaC1_"+scientific_name+".tif")
