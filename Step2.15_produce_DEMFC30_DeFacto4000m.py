...
#produce DEMFC30_DeFacto4000m_+scientific_name+".tif"
...
DeFacto4000m_roi= "C:\\859K_sl559\\Data\\SumUp_Dejure_Defacto\\Reclass_DeFacto_4000m.tif"
...
for fileName in fileList:
    ...
    outRas = Raster(fileName)*Raster(DeFacto4000m_roi)
    outRas.save("DEMFC30_DeFacto4000m_"+scientific_name+".tif")
    print(outRas)
