...
gp.workspace = r"H:\\map\\binbin\\bird_endemic_new\\habitat\\delete"
...
habitat="H:\\China\\landcover_China\\ESA\\China_landcover_clssification_albers\\for_agri_alb"
#check the sptaial analyst extension
gp.CheckOutExtension("Spatial")
gp.toolbox = "analysis"

#create the ouput file
outraster=r'H:\\map\\binbin\\bird_endemic_new\\habitat\\After\\reftX'
i=0
FCs = gp.ListRasters("*")
FCs.Reset()
FC = FCs.Next()
