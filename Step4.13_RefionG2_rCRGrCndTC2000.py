...
RegionG_FC2000_MtoNR_rC_FC30_ROIexpanded.tif, and classified the clusters with 
cellsize smaller than 113 to nodata, the result is
Reclass_RegionG_FC2000_ROIexpanded.tif 
...
print (os.path.exists("C:\\859K_sl559\\Scratch3\\RegionG2_rCRGrCndTC2000_ROIexpanded.tif"))
