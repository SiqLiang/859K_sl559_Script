...
print (os.path.exists("C:\\859K_sl559\\Doc\\ReBy_FC30_RasterArea.txt"))
# Create a new file in the current working directory, write some text, and remember to close it
BL_Map_fileObj = open("ReBy_FC30_RasterArea.txt",'w')
BL_Map_fileObj.truncate(0) # clear eveything already in the txt file
BL_Map_fileObj.write('ReBy_FC30_Species, '+'Area_sqkm2'+"\n")
...
for fileName in fileList:
    print(fileName)
    scientific_name = fileName[10:fileName.rfind('.')]
